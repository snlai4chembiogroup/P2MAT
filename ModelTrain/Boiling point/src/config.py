...
# Date      : April 8, 2026
# Purpose   : Central configuration for the boiling point QSAR pipeline: paths,
#             experiment axes, and hyperparameter search spaces.
######################################################
"""
config.py
---------
...
# Column definitions
# ---------------------------------------------------------------------------
DROP_COLS  = ["#PubChem", "BP_C", "smiles"]  # Columns to drop before modeling
TARGET_COL = "BP_K"
