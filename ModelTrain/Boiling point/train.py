...
# Date      : May 3, 2026
# Purpose   : Orchestrates the complete boiling point QSAR machine-learning pipeline.
######################################################
"""
train.py
-------
...
# Propagate the filter to joblib worker processes (they don't inherit Python's
# warnings state, but they do inherit env vars set before they are spawned).
